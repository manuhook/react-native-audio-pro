...
import { ambientEmitter, emitter } from "./emitter.js";
import { internalStore } from "./internalStore.js";
import { guardTrackPlaying, logDebug, normalizeVolume, validateTrack, validateFilePath } from "./utils.js";
import { AudioProAmbientEventType, AudioProEventType, AudioProState, DEFAULT_CONFIG, DEFAULT_SEEK_MS } from "./values.js";
...
export const AudioPro = {
   ...
   */
  seekForward(amountMs = DEFAULT_SEEK_MS) {
   ...
   */
  seekBack(amountMs = DEFAULT_SEEK_MS) {
   ...
   */
  getProgressInterval() {
    return internalStore.getState().configureOptions.progressIntervalMs ?? DEFAULT_CONFIG.progressIntervalMs;
  },
  // ==============================
